                            ...
                            <div class="card flex-fill">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped table-hover" id="dataTable">
                                        <thead>
                                            <tr>
                                                <th>NO <i class="fas fa-sort-numeric-up"></i></th>
                                                <th>Tahun <i class="fas fa-calendar-alt"></i></th>
                                                <th>Nominal <i class="fas fa-dollar-sign"></i></th>
                                        ...
                                        while ($data = mysqli_fetch_array($query)){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button data-toggle="modal" data-target="#editspp<?php echo $data['id_spp']; ?>" data-tahun="<?php echo $data['tahun']; ?>" data-nominal="<?php echo $data['nominal']; ?>" class="btn btn-warning btn-sm editspp"><i class="fas fa-edit"></i></button>
                                                    <button data-toggle="modal" data-target="#hapus<?php echo $data['id_spp']; ?>" class="btn btn-danger btn-sm hapusspp"><i class="fas fa-trash-alt"></i></button>
                                                </td>
                                            </tr>
